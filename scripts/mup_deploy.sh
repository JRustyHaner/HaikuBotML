...
rm -rf ~/scholarlyotter/scholarlyotter/.deploy/settings.json

echo "Writing new Meteor Up settings.json."
touch ~/scholarlyotter/scholarlyotter/.deploy/settings.json
...
echo "module.exports = {
  ...
  app: {
    ...
    env: {
      ROOT_URL: '"$TARGET_URL"',
      MONGO_URL: 'mongodb://localhost:27017/scholarlyotter',
      PORT: 80
    }
  },
  mongo: {
